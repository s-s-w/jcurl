...
public class XStreamIOTest extends TestBase {
	...
	public void testComputedTrajectorySet() throws IOException {
		...
		assertEquals(
				...
				"        </params>\n" + 
				"      </collider>\n" + 
				"      <collissionDetector class=\"BisectionCollissionDetector\"/>\n" + 
	...
	public void testCurveStoreRaw() {
		...
		assertEquals(
				...
				"                <double-array>\n" + 
				"                  <double>0.0</double>\n" + 
				"                  <double>0.5810458013007562</double>\n" + 
				"                  <double>-0.053584879422683564</double>\n" + 
				"                </double-array>\n" + 
				"                <double-array>\n" + 
				"                  <double>1.6510599035839595</double>\n" + 
				"                  <double>1.5707963267948966</double>\n" + 
				"                </double-array>\n" + 
				"              </params>\n" + 
				"            </base>\n" + 
				"            <t0>2.2639031849394087</t0>\n" + 
				"            <trafo>\n" + 
				"              <double>-0.32808398622589424</double>\n" + 
				"              <double>0.9446485579209484</double>\n" + 
				"              <double>-0.9446485579209484</double>\n" + 
				"              <double>-0.32808398622589424</double>\n" + 
				"              <double>0.0</double>\n" + 
				"              <double>2.1167288463262723</double>\n" + 
				"            </trafo>\n" + 
				"          </curve>\n" + 
				"          <t0>2.2639031849394087</t0>\n" + 
				"        </org.jcurl.math.CurveCombined_-Part>\n" + 
				...
				"            <a>12.072568840253496</a>\n" + 
				"            <x>-1.48795141709883</x>\n" + 
				"            <y>1.5999514393860033</y>\n" + 
				"          </curve>\n" + 
				"          <t0>7.6856360269741355</t0>\n" + 
				"        </org.jcurl.math.CurveCombined_-Part>\n" + 
				"      </parts>\n" + 
				"    </org.jcurl.math.CurveCombined>\n" + 
				"    <org.jcurl.math.CurveCombined>\n" + 
				...
				"                <double-array>\n" + 
				"                  <double>0.0</double>\n" + 
				"                  <double>1.6729986873143534</double>\n" + 
				"                  <double>-0.053584879422683564</double>\n" + 
				"                </double-array>\n" + 
				"                <double-array>\n" + 
				"                  <double>3.592716240244007</double>\n" + 
				"                  <double>0.0</double>\n" + 
				"                </double-array>\n" + 
				"              </params>\n" + 
				"            </base>\n" + 
				...
				"            <trafo>\n" + 
				"              <double>-0.9446485579209484</double>\n" + 
				"              <double>-0.32808398622589413</double>\n" + 
				"              <double>0.32808398622589413</double>\n" + 
				"              <double>-0.9446485579209484</double>\n" + 
				"              <double>0.1</double>\n" + 
				...
				"          <curve class=\"org.jcurl.core.impl.CurveStill\">\n" + 
				"            <a>0.7853981633974483</a>\n" + 
				"            <x>4.384241899728249</x>\n" + 
				"            <y>-10.506769897996211</y>\n" + 
				"          </curve>\n" + 
				"          <t0>17.874638016138704</t0>\n" + 
				"        </org.jcurl.math.CurveCombined_-Part>\n" + 
				"      </parts>\n" + 
				"    </org.jcurl.math.CurveCombined>\n" + 
				"    <org.jcurl.math.CurveCombined>\n" + 
	...
	public void testRaw() {
		...
		assertEquals(
				...
				"    </params>\n" + 
				"  </collider>\n" + 
				"  <collissionDetector class=\"org.jcurl.core.impl.BisectionCollissionDetector\"/>\n" + 
	...
	public void testStoredTrajectorySet() throws IOException {
		...
		assertEquals("<IOTrajectories>\n" + 
				...
				"                    <params>\n" + 
				"                      <double-array>0.0</double-array>\n" + 
				"                      <double-array>0.0 0.5810458013007562 -0.053584879422683564</double-array>\n" + 
				"                      <double-array>1.6510599035839595 1.5707963267948966</double-array>\n" + 
				"                    </params>\n" + 
				"                  </base>\n" + 
				"                  <t0>2.2639031849394087</t0>\n" + 
				"                  <trafo>-0.32808398622589424 0.9446485579209484 -0.9446485579209484 -0.32808398622589424 0.0 2.1167288463262723</trafo>\n" + 
				"                </curve>\n" + 
				"                <t0>2.2639031849394087</t0>\n" + 
				"              </part>\n" + 
				"              <part>\n" + 
				...
				"                    <params>\n" + 
				"                      <double-array>0.0</double-array>\n" + 
				"                      <double-array>0.0 1.6729986873143534 -0.053584879422683564</double-array>\n" + 
				"                      <double-array>3.592716240244007 0.0</double-array>\n" + 
				"                    </params>\n" + 
				"                  </base>\n" + 
				"                  <t0>2.2639031849394087</t0>\n" + 
				"                  <trafo>-0.9446485579209484 -0.32808398622589413 0.32808398622589413 -0.9446485579209484 0.1 1.8287999629974365</trafo>\n" + 
				"                </curve>\n" + 
				"                <t0>2.2639031849394087</t0>\n" + 
				"              </part>\n" + 
				"              <part>\n" + 
