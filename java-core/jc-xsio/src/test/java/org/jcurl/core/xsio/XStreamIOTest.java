...
public class XStreamIOTest extends TestBase {
    ...
    public void testComputedTrajectorySet() throws IOException {
        ...
        assertEquals(
                "<org.jcurl.core.io.IODocument serialization=\"custom\">\n"
                        ...
                        + "    <int>0</int>\n"
                        + "  </map>\n"
                        + "  <org.jcurl.core.io.IODocument>\n"
                        + "    <default>\n"
                        + "      <root class=\"org.jcurl.core.io.IOTrajectories\">\n"
                        + "        <trajectories>\n"
                        + "          <CurveManager>\n"
                        + "            <annotations serialization=\"custom\">\n"
                        + "              <unserializable-parents/>\n"
                        + "              <map>\n"
                        + "                <default>\n"
                        + "                  <loadFactor>0.75</loadFactor>\n"
                        ...
                        + "    </default>\n"
                        + "  </org.jcurl.core.io.IODocument>\n"
                        + "</org.jcurl.core.io.IODocument>", x);
