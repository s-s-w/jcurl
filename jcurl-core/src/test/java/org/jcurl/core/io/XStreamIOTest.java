...
public class XStreamIOTest extends TestCase {
    ...
    public void testStoredTrajectorySet() {
        ...
        String x = xs.toXML(st);
        // System.out.println(x);
        assertEquals(
                "<org.jcurl.core.base.StoredTrajectorySet>\n"
                        + "  <store>\n"
                        + "    <curve>\n"
                        ...
                        + "              </trafo>\n"
                        + "              <rc class=\"org.jcurl.math.PolynomeCurve\">\n"
                        + "                <params>\n"
                        + "                  <double-array>\n"
                        + "                    <double>0.0</double>\n"
                        + "                  </double-array>\n"
                        ...
                        + "      </org.jcurl.math.CurveCombined>\n"
                        + "    </curve>\n" + "  </store>\n"
                        + "</org.jcurl.core.base.StoredTrajectorySet>", x);
        TrajectorySet b = (TrajectorySet) xs.fromXML(x);
        b.setCurrentTime(11);
        assertEquals(x, xs.toXML(b));
    }
