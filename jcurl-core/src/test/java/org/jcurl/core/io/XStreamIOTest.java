    ...
    public void testStoredTrajectorySet() {
        ...
        assertEquals(
                "<StoredTrajectory>\n"
                        ...
                        + "                <params>\n"
                        + "                  <double-array>0.0</double-array>\n"
                        + "                  <double-array>0.0 0.2442188609265664 -0.0535848758171096</double-array>\n"
                        + "                  <double-array>2.541398097787834 2.8927673233271416</double-array>\n"
                        + "                </params>\n"
                        + "              </base>\n"
                        ...
                        + "              <a>11.038518805999932</a>\n"
                        + "              <x>-0.26286117733583597</x>\n"
                        + "              <y>2.0254350617673333</y>\n"
                        + "            </curve>\n"
                        + "            <t0>5.896708298570097</t0>\n"
                        + "          </CurvePart>\n"
                        + "        </parts>\n"
                        + "      </CombinedCurve>\n"
                        + "      <CombinedCurve>\n"
                        ...
                        + "                <params>\n"
                        + "                  <double-array>0.0</double-array>\n"
                        + "                  <double-array>0.0 0.9389250968779904 -0.0535848758171096</double-array>\n"
                        + "                  <double-array>0.7853981633974483 1.321970996532245</double-array>\n"
                        + "                </params>\n"
                        + "              </base>\n"
                        + "              <t0>3.617904278509095</t0>\n"
                        + "              <trafo>-0.9693440023087092 -0.2457075602990949 0.2457075602990949 -0.9693440023087092 0.1 1.8287999629974365</trafo>\n"
                        + "            </curve>\n"
                        + "            <t0>3.617904278509095</t0>\n"
                        + "          </CurvePart>\n"
                        + "          <CurvePart>\n"
                        + "            <curve class=\"PointCurve\">\n"
                        + "              <a>9.473977461246808</a>\n"
                        + "              <x>1.1105974430440255</x>\n"
                        + "              <y>-2.1581207852724815</y>\n"
                        + "            </curve>\n"
                        + "            <t0>12.379006011817312</t0>\n"
                        + "          </CurvePart>\n"
                        + "        </parts>\n"
                        + "      </CombinedCurve>\n"
                        + "      <CombinedCurve>\n"
    ...
    public void testCurveStore() {
        ...
        assertEquals(
                "<org.jcurl.core.base.CurveStore>\n"
                        ...
                        + "  </curve>\n"
                        + "  <stopper class=\"org.jcurl.core.model.NewtonStopDetector\"/>\n"
                        + "</org.jcurl.core.base.CurveStore>", x);
    }
