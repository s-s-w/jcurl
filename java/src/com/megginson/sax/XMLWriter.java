...
public class XMLWriter extends XMLFilterImpl {
     ...
     * {@link #endElement(String) endElement}event will be passed on down the
     * filter chain.
     * 
     * @param uri
    ...
    private void forceNSDecls() {
        for (Iterator it = forcedDeclTable.keySet().iterator(); it.hasNext();) {
     ...
     * @see #forceNSDecl(java.lang.String,java.lang.String)
     */
    private void setPrefix(String uri, String prefix) {
        prefixTable.put(uri, prefix);
    }
