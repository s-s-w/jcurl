...
/**
 * See {@link XmlSimpleWriter.Content}
 * 
 * @author m
 * @version $Id$
 * @see jcurl.core.util.XmlSimpleWriterTest
 */
public class XmlSimpleWriter {

    /**
     * A very simple xml serializer implementing a SAX content-handler. Can
     * handle changing default namespaces. Checks well-formedness. Does not
     * support smart namespace prefix handling - which it should.
     * 
     * @see XmlSimpleWriterTest
     * @author m
     */
    public static class Content implements ContentHandler {
        ...
        public Content(final OutputStream stream, final String encoding,
        ...
        public Content(final Writer target, final boolean indent) {
            this.target = target;
            this.encoding = null;
            this.indent = indent;
        }
        ...
        /**
         * Write the element end tag. Checks for a matching qname, but should
        ...
        /**
         * Should remove a prefix mapping for following child nodes. Does
         * nothing right now.
         * 
